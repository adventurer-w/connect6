...
public class RoadTable {
    ...
    //横+纵+斜上+斜
    private Road[][] basicRoads = new Road[SIDE * SIDE][4];
    //黑白
    private RoadList[][] wbRoads = new RoadList[7][7];
...
//    public final static int[] eValueS = {0, 17, 78, 241, 988, 1030, 10000};
    public final static int[] mValueS = {0,9,520,2070,7890,10020,1000000};
    public final static int[] eValueS = {0,3,480,2670,3887,4900,1000000};
}
